...
public class ConfigurationConsistencyTest {
    ...
    @Test
    void RedisTemplate가_일치한지_확인() {
        RedisTemplate<String, Object> bean = (RedisTemplate<String, Object>) context.getBean("redisTemplate");
        RedisTemplate<String, Object> mock = MockAppConfig.redisTemplate();

        Assertions.assertEquals(bean.getClass(), mock.getClass());
    }
}
